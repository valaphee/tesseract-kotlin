 ...
 * @author Kevin Ludwig
 */
object SectorType : BaseEntityType("sector")

typealias Sector = EntityOfWorld<SectorType>
...
val Sector.position get() = findAttribute(Location::class).position

fun encodePosition(x: Int, z: Int) = ((x and 0x3FFFFF).toLong() shl 42) or ((z and 0x3FFFFF).toLong() shl 20)

fun decodePosition(coordinate: Long) = Int2((coordinate shr 42).toInt(), ((coordinate shl 22) shr 42).toInt())
