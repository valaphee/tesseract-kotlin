...
dependencies {
    ...
    api("com.valaphee:foundry-databind:1.2.1-8-gf0fec9c")
    api("com.valaphee:foundry-math:1.2.1-8-gf0fec9c")
    api("io.netty:netty-buffer:4.1.66.Final")
    api("io.netty:netty-transport-native-epoll:4.1.66.Final:linux-x86_64")
    api("io.netty:netty-transport-native-kqueue:4.1.66.Final:osx-x86_64")
    api("io.netty:netty-codec-http2:4.1.66.Final")
    ...
    api("org.jetbrains.kotlin:kotlin-reflect:1.5.30-M1")
